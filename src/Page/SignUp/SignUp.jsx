...
const SignUp = () => {
    ...
    const onSubmit = (data) => {
        console.log(data);
        const { name, number, email, photo, password, confirmPass } = data;
        console.log(number);
    ...
    return (
        <div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-5 bg-primary_bg_color mx-3  p-10 md:w-4/6 md:mx-auto md:px-28 md:py-20 lg:px-44 rounded-2xl">
                <div>
