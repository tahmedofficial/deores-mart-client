...
const AdminDashboard = () => {
    return (
        <ul className="flex flex-col gap-3 px-5 pt-3 bg-primary_card_color rounded-xl w-56 h-full min-h-screen">
            ...
            <li><NavLink className={({ isActive }) => isActive ? "btn w-full bg-black text-white" : "btn w-full"} to="/dashboard/allProductManage"><TiThSmall />Ordered Item</NavLink></li>
            <li><NavLink className={({ isActive }) => isActive ? "btn w-full bg-black text-white" : "btn w-full"} to="/dashboard/orders"><FaBorderAll />Ordered Item</NavLink></li>
